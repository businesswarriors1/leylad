...
export const metadata: Metadata = {
  title: "IPL Hair Removal Point Cook for Face & Body",
  description:
    "IPL hair removal in Point Cook for smoother face and body, with long-lasting reduction from our 5-star specialist clinic. Book your consultation today.",
};

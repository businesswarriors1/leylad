...
export const metadata: Metadata = {
  ...
  description:
    "Medik8 facial protocols at Leyla D Point Cook — clinical-grade peels, hydration and prescriptive skin courses from one of the UK's most respected cosmeceutical brands.",
};
